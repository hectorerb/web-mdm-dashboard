...
* **dashboard:** add PluginFlyvemdmPolicy to the item type list ([5c6521f](https://github.com/hectorerb/web-mdm-dashboard/commit/5c6521f))
...
* **dashboard:** use only https for the base url of glpi ([30cc368](https://github.com/hectorerb/web-mdm-dashboard/commit/30cc368))
...
* **entity:** remove duplicate header in 'ChangeTokenLife' component ([263be60](https://github.com/hectorerb/web-mdm-dashboard/commit/263be60))
...
* **geolocation:** show list of locations and mark them on the map ([ffa1aa7](https://github.com/hectorerb/web-mdm-dashboard/commit/ffa1aa7))
...
* **login:** save current user in reducer store ([a493ff8](https://github.com/hectorerb/web-mdm-dashboard/commit/a493ff8))
...
* **package:** update babel-jest to version 22.0.3 ([78e00f4](https://github.com/hectorerb/web-mdm-dashboard/commit/78e00f4))
...
* **package:** update eslint to version 4.19.0 ([8b950cc](https://github.com/hectorerb/web-mdm-dashboard/commit/8b950cc))
...
* **package:** update html-webpack-plugin to version 3.0.0 ([96aa2d5](https://github.com/hectorerb/web-mdm-dashboard/commit/96aa2d5))
...
* **package:** update style-loader to version 0.20.0 ([737a792](https://github.com/hectorerb/web-mdm-dashboard/commit/737a792))
...
* **profile:** pass the correct parameters for the request ([77caf5e](https://github.com/hectorerb/web-mdm-dashboard/commit/77caf5e))
...
* **users:** break line for profile informations ([4ed5953](https://github.com/hectorerb/web-mdm-dashboard/commit/4ed5953))
...
* **about:** show System information data of glpi ([bcef3bb](https://github.com/hectorerb/web-mdm-dashboard/commit/bcef3bb))
...
* **animations:** create toggle animation list from redux store ([e3a40e0](https://github.com/hectorerb/web-mdm-dashboard/commit/e3a40e0))
...
* **applications:** request apps using glpi library ([30c2add](https://github.com/hectorerb/web-mdm-dashboard/commit/30c2add))
...
* **dashboard:** add release notes page to i18n ([6f96ebf](https://github.com/hectorerb/web-mdm-dashboard/commit/6f96ebf))
...
* **dashboard:** get the count of devices by platform ([d83ca76](https://github.com/hectorerb/web-mdm-dashboard/commit/d83ca76))
...
* **devices:** add button to request inventory ([077633e](https://github.com/hectorerb/web-mdm-dashboard/commit/077633e))
...
* **devices:** create Applications component ([d769438](https://github.com/hectorerb/web-mdm-dashboard/commit/d769438))
...
* **divices:** add logic of actionList ([d460fde](https://github.com/hectorerb/web-mdm-dashboard/commit/d460fde))
...
* **files:** add route to get list files ([9503386](https://github.com/hectorerb/web-mdm-dashboard/commit/9503386))
...
* **fleets:** add route to create new fleet ([2e23019](https://github.com/hectorerb/web-mdm-dashboard/commit/2e23019))
...
* **fleets:** get new policy selected ([ebfe05c](https://github.com/hectorerb/web-mdm-dashboard/commit/ebfe05c))
...
* **form:** add get all items case ([6b7c38d](https://github.com/hectorerb/web-mdm-dashboard/commit/6b7c38d))
* **forms:** add title to form sections ([24bf71f](https://github.com/hectorerb/web-mdm-dashboard/commit/24bf71f))
* **forms:** consult all the items in the 'searchItems' ([4d52a5e](https://github.com/hectorerb/web-mdm-dashboard/commit/4d52a5e))
* **forms:** receive an array of objects in the selects ([425d44b](https://github.com/hectorerb/web-mdm-dashboard/commit/425d44b))
* **Forms:** create a scheme for user forms ([58ab923](https://github.com/hectorerb/web-mdm-dashboard/commit/58ab923))
* **geolocation:** create geolocation device page ([c3c450d](https://github.com/hectorerb/web-mdm-dashboard/commit/c3c450d))
* **glpi:** send glpi function to components ([7d6771d](https://github.com/hectorerb/web-mdm-dashboard/commit/7d6771d))
* **glpi-hoc:** create hoc for share glpi client ([314ff93](https://github.com/hectorerb/web-mdm-dashboard/commit/314ff93))
* **header:** add full route and navigation ([a1c5efd](https://github.com/hectorerb/web-mdm-dashboard/commit/a1c5efd))
* **HeaderAdminDashboard:** add a confirmation message to close session ([02445db](https://github.com/hectorerb/web-mdm-dashboard/commit/02445db))
* **HeaderAdminDashboard:** add a section of logout and current user ([35caa4f](https://github.com/hectorerb/web-mdm-dashboard/commit/35caa4f))
* **HeaderAdminDashboard:** create a function to close the session ([dd0da40](https://github.com/hectorerb/web-mdm-dashboard/commit/dd0da40))
* **helpCenter:** add an AutoSuggestBox of articles ([cd0350c](https://github.com/hectorerb/web-mdm-dashboard/commit/cd0350c))
* **helpCenter:** create a function to filter articles by name ([5083c09](https://github.com/hectorerb/web-mdm-dashboard/commit/5083c09))
* **helpCenter:** create component HelpCenterList ([b0e701c](https://github.com/hectorerb/web-mdm-dashboard/commit/b0e701c))
* **helpCenter:** create component HelpCenterList ([2936959](https://github.com/hectorerb/web-mdm-dashboard/commit/2936959))
* **helpCenter:** create send feedback section ([80aca26](https://github.com/hectorerb/web-mdm-dashboard/commit/80aca26))
* **helpCenter:** filter articles with the search button ([7a2b3d7](https://github.com/hectorerb/web-mdm-dashboard/commit/7a2b3d7))
* **helpCenter:** place the auto suggest box on the top ([2b30cd3](https://github.com/hectorerb/web-mdm-dashboard/commit/2b30cd3))
* **home:** add HomeDashboard to i18n ([0da8e0e](https://github.com/hectorerb/web-mdm-dashboard/commit/0da8e0e))
* **i18n:** add empty list message ([2cee7da](https://github.com/hectorerb/web-mdm-dashboard/commit/2cee7da))
* **i18n:** add english strings ([423a265](https://github.com/hectorerb/web-mdm-dashboard/commit/423a265))
* **i18n:** add i18n to about, dashboard pages ([169454b](https://github.com/hectorerb/web-mdm-dashboard/commit/169454b))
* **i18n:** add strings to create account page ([d5dce75](https://github.com/hectorerb/web-mdm-dashboard/commit/d5dce75))
* **i18n:** add translation hoc to dashboard page ([9d98ba1](https://github.com/hectorerb/web-mdm-dashboard/commit/9d98ba1))
* **i18n:** added strings for about section ([fe0cb1c](https://github.com/hectorerb/web-mdm-dashboard/commit/fe0cb1c))
* **i18n:** create test of login ([c9af5da](https://github.com/hectorerb/web-mdm-dashboard/commit/c9af5da))
* **i18n:** improve names of the variables ([9fa0e64](https://github.com/hectorerb/web-mdm-dashboard/commit/9fa0e64))
* **i18n:** improve unit test ([2a8c8fe](https://github.com/hectorerb/web-mdm-dashboard/commit/2a8c8fe))
* **iconItemList:** add an onClick function to the image ([dc0ed80](https://github.com/hectorerb/web-mdm-dashboard/commit/dc0ed80))
* **images:** add image of logout ([a3d6916](https://github.com/hectorerb/web-mdm-dashboard/commit/a3d6916))
* **Input:** add 'required' parameter ([ddf06a8](https://github.com/hectorerb/web-mdm-dashboard/commit/ddf06a8))
* **Input:** create button to delete ([247e82e](https://github.com/hectorerb/web-mdm-dashboard/commit/247e82e))
* **Input:** force validation when necessary ([eb28195](https://github.com/hectorerb/web-mdm-dashboard/commit/eb28195))
* **Input:** integrate error messages ([4d82cc4](https://github.com/hectorerb/web-mdm-dashboard/commit/4d82cc4))
* **Input:** validate the data in input onBlur or when there is an error ([f0aa0ef](https://github.com/hectorerb/web-mdm-dashboard/commit/f0aa0ef))
* **invitations:** add button resend invitation ([2ecdd18](https://github.com/hectorerb/web-mdm-dashboard/commit/2ecdd18))
* **invitations:** add InvitationsList component to i18n ([884af37](https://github.com/hectorerb/web-mdm-dashboard/commit/884af37))
* **invitations:** add InvitationsPendingPage component to i18n ([ba967ab](https://github.com/hectorerb/web-mdm-dashboard/commit/ba967ab))
* **invitations:** add message of 'No Logs Available' ([7d270a8](https://github.com/hectorerb/web-mdm-dashboard/commit/7d270a8))
* **invitations:** add notification to delete multiple invitations ([d411b46](https://github.com/hectorerb/web-mdm-dashboard/commit/d411b46))
* **invitations:** add notification to resend invitation ([19bfa64](https://github.com/hectorerb/web-mdm-dashboard/commit/19bfa64))
* **invitations:** add pagination ([e303f7d](https://github.com/hectorerb/web-mdm-dashboard/commit/e303f7d))
* **invitations:** add progressive loading to listview ([412f3d9](https://github.com/hectorerb/web-mdm-dashboard/commit/412f3d9))
* **invitations:** add routes to i18n ([3345397](https://github.com/hectorerb/web-mdm-dashboard/commit/3345397))
* **invitations:** create a detail screen for the invitations logs ([1ba7d05](https://github.com/hectorerb/web-mdm-dashboard/commit/1ba7d05))
* **invitations:** create invitation to enroll device ([905954e](https://github.com/hectorerb/web-mdm-dashboard/commit/905954e))
* **invitations:** create pending invitations component ([9efcec7](https://github.com/hectorerb/web-mdm-dashboard/commit/9efcec7))
* **invitations:** create router for invitations ([0467714](https://github.com/hectorerb/web-mdm-dashboard/commit/0467714))
* **invitations:** delete item using glpi library ([dbcb79f](https://github.com/hectorerb/web-mdm-dashboard/commit/dbcb79f))
* **invitations:** get invitations logs ([b711bf9](https://github.com/hectorerb/web-mdm-dashboard/commit/b711bf9))
* **invitations:** get invitations using glpi library ([1fabb44](https://github.com/hectorerb/web-mdm-dashboard/commit/1fabb44))
* **invitations:** organize the list of items ([85af678](https://github.com/hectorerb/web-mdm-dashboard/commit/85af678))
* **invitations:** remove items of the list ([9294266](https://github.com/hectorerb/web-mdm-dashboard/commit/9294266))
* **invitations:** request order using glpi library ([3ba47bd](https://github.com/hectorerb/web-mdm-dashboard/commit/3ba47bd))
* **invitations:** resend invitations ([7b40dac](https://github.com/hectorerb/web-mdm-dashboard/commit/7b40dac))
* **invitations:** select items of the list ([889738a](https://github.com/hectorerb/web-mdm-dashboard/commit/889738a))
* **invitations:** send invitation enroll new device ([4a53e11](https://github.com/hectorerb/web-mdm-dashboard/commit/4a53e11))
* **invitations:** show grouped elements on list ([e9c358e](https://github.com/hectorerb/web-mdm-dashboard/commit/e9c358e))
* **itcss:** add css architecture ([263555e](https://github.com/hectorerb/web-mdm-dashboard/commit/263555e))
* **l18n:** Circle CI & Transifex Integration ([#301](https://github.com/hectorerb/web-mdm-dashboard/issues/301)) ([7768ad4](https://github.com/hectorerb/web-mdm-dashboard/commit/7768ad4))
* **list:** change list dynamically with location ([492cc08](https://github.com/hectorerb/web-mdm-dashboard/commit/492cc08))
* **lists:** add lists base for all pages ([aca36b4](https://github.com/hectorerb/web-mdm-dashboard/commit/aca36b4))
* **loading:** create loading indicator for content ([7788077](https://github.com/hectorerb/web-mdm-dashboard/commit/7788077))
* **loading:** create small loading component ([2a1384f](https://github.com/hectorerb/web-mdm-dashboard/commit/2a1384f))
* **login:** add link to '/signIn' on 'Create one!' ([1373984](https://github.com/hectorerb/web-mdm-dashboard/commit/1373984))
* **login:** add toast notifications to login user ([5bb38f6](https://github.com/hectorerb/web-mdm-dashboard/commit/5bb38f6))
* **login:** create 'ForgotPassword' component ([d8ed739](https://github.com/hectorerb/web-mdm-dashboard/commit/d8ed739))
* **login:** create 'LoginContainer' component ([b5347c0](https://github.com/hectorerb/web-mdm-dashboard/commit/b5347c0))
* **login:** create 'SignIn' component ([7bf7fc0](https://github.com/hectorerb/web-mdm-dashboard/commit/7bf7fc0))
* **login:** create a route for 'ForgotPassword' in '/forgotPassword' ([f5aa181](https://github.com/hectorerb/web-mdm-dashboard/commit/f5aa181))
* **login:** create request to login endponint ([b15fff8](https://github.com/hectorerb/web-mdm-dashboard/commit/b15fff8))
* **login:** get full session data ([dd5153c](https://github.com/hectorerb/web-mdm-dashboard/commit/dd5153c))
* **login:** init user session with basic authentication ([1801dfb](https://github.com/hectorerb/web-mdm-dashboard/commit/1801dfb))
* **login:** set focus inputs for login ([2c15366](https://github.com/hectorerb/web-mdm-dashboard/commit/2c15366))
* **login:** show dashboard when user is authenticated ([7f617a4](https://github.com/hectorerb/web-mdm-dashboard/commit/7f617a4))
* **login:** show loading indicator ([f9c2d69](https://github.com/hectorerb/web-mdm-dashboard/commit/f9c2d69))
* **logout:** kill session after logout ([9089220](https://github.com/hectorerb/web-mdm-dashboard/commit/9089220))
* **logout:** remove local store after logout ([c2efb0e](https://github.com/hectorerb/web-mdm-dashboard/commit/c2efb0e))
* **logout:** remove session token from local store ([dea2944](https://github.com/hectorerb/web-mdm-dashboard/commit/dea2944))
* **Map:** move to selected localization ([170495a](https://github.com/hectorerb/web-mdm-dashboard/commit/170495a))
* **maps:** add all markers in a group ([153e853](https://github.com/hectorerb/web-mdm-dashboard/commit/153e853))
* **maps:** add markers to the map ([0853e0b](https://github.com/hectorerb/web-mdm-dashboard/commit/0853e0b))
* **maps:** center map and zoom ([f536252](https://github.com/hectorerb/web-mdm-dashboard/commit/f536252))
* **maps:** clean the old markers ([0709644](https://github.com/hectorerb/web-mdm-dashboard/commit/0709644))
* **maps:** create a component of maps ([66d36fb](https://github.com/hectorerb/web-mdm-dashboard/commit/66d36fb))
* **menu:** make a way to logout ([dc366a8](https://github.com/hectorerb/web-mdm-dashboard/commit/dc366a8))
* **menu:** make the necessary redirection in all texts ([9e026bc](https://github.com/hectorerb/web-mdm-dashboard/commit/9e026bc))
* **menu:** wipe local storage in the reducer ([471b896](https://github.com/hectorerb/web-mdm-dashboard/commit/471b896))
* **new-settings:** add routes to the container ([b3706a5](https://github.com/hectorerb/web-mdm-dashboard/commit/b3706a5))
* **new-settings:** add routes to the container ([21e268c](https://github.com/hectorerb/web-mdm-dashboard/commit/21e268c))
* **new-settings:** add routes to the container ([#403](https://github.com/hectorerb/web-mdm-dashboard/issues/403)) ([020003c](https://github.com/hectorerb/web-mdm-dashboard/commit/020003c))
* **notFound:** create 'NotFound' component ([656b00b](https://github.com/hectorerb/web-mdm-dashboard/commit/656b00b))
* **notFound:** show 'NotFound' component ([b52b268](https://github.com/hectorerb/web-mdm-dashboard/commit/b52b268))
* **notifications:** add notifications message ([5f188b5](https://github.com/hectorerb/web-mdm-dashboard/commit/5f188b5))
* **notifications:** create a function to create natives notifications ([44db2f2](https://github.com/hectorerb/web-mdm-dashboard/commit/44db2f2))
* **notifications:** create function to show notifications ([205ddb0](https://github.com/hectorerb/web-mdm-dashboard/commit/205ddb0))
* **notifications:** create the component of toast notifications ([a82785b](https://github.com/hectorerb/web-mdm-dashboard/commit/a82785b))
* **notifications:** handle notifications from redux ([30a63b3](https://github.com/hectorerb/web-mdm-dashboard/commit/30a63b3))
* **notifications:** receive messages as strings ([4f85e6a](https://github.com/hectorerb/web-mdm-dashboard/commit/4f85e6a))
* **notifications:** request permission to use native notifications ([4f0f0a7](https://github.com/hectorerb/web-mdm-dashboard/commit/4f0f0a7))
* **notifications:** save notifications settings in the local storage ([a6e1936](https://github.com/hectorerb/web-mdm-dashboard/commit/a6e1936))
* **notifications:** show and hide notifications ([687e0cb](https://github.com/hectorerb/web-mdm-dashboard/commit/687e0cb))
* **notifications:** show the type of notifications configured ([ef51b7d](https://github.com/hectorerb/web-mdm-dashboard/commit/ef51b7d))
* **pages:** add refresh action to toolbar list ([2f062da](https://github.com/hectorerb/web-mdm-dashboard/commit/2f062da))
* **pages:** create dynamic components for menu section ([5f17ef2](https://github.com/hectorerb/web-mdm-dashboard/commit/5f17ef2))
* **password:** request recovery password ([b78d221](https://github.com/hectorerb/web-mdm-dashboard/commit/b78d221))
* **polices:** clean the input of the AutoSuggestBox ([cc78570](https://github.com/hectorerb/web-mdm-dashboard/commit/cc78570))
* **polices:** load the selected policies with a click ([22140cd](https://github.com/hectorerb/web-mdm-dashboard/commit/22140cd))
* **polices:** validate that a policy is not added more than once ([7af6f10](https://github.com/hectorerb/web-mdm-dashboard/commit/7af6f10))
* **polices:** validate the existence of the policy ([3b27ae4](https://github.com/hectorerb/web-mdm-dashboard/commit/3b27ae4))
* **policies:** add an auto-suggest box ([60147c0](https://github.com/hectorerb/web-mdm-dashboard/commit/60147c0))
* **policies:** create render min and max os version ([37baeee](https://github.com/hectorerb/web-mdm-dashboard/commit/37baeee))
* **policies:** show min and max os version ([8698498](https://github.com/hectorerb/web-mdm-dashboard/commit/8698498))
* **profiles:** add 'more information' section ([89d982e](https://github.com/hectorerb/web-mdm-dashboard/commit/89d982e))
* **profiles:** add a section of valid dates ([6e29697](https://github.com/hectorerb/web-mdm-dashboard/commit/6e29697))
* **profiles:** add confirmation message to delete emails ([9902885](https://github.com/hectorerb/web-mdm-dashboard/commit/9902885))
* **profiles:** add the section of the profile image ([1bc24a4](https://github.com/hectorerb/web-mdm-dashboard/commit/1bc24a4))
* **profiles:** async loading and get real user data ([136349e](https://github.com/hectorerb/web-mdm-dashboard/commit/136349e))
* **profiles:** change password ([4377bdd](https://github.com/hectorerb/web-mdm-dashboard/commit/4377bdd))
* **profiles:** create a component to textarea ([3464174](https://github.com/hectorerb/web-mdm-dashboard/commit/3464174))
* **profiles:** create a component to the date pickers ([9c3534f](https://github.com/hectorerb/web-mdm-dashboard/commit/9c3534f))
* **profiles:** load category information ([f5e2a28](https://github.com/hectorerb/web-mdm-dashboard/commit/f5e2a28))
* **profiles:** load defaultEntity information ([a2a7a4b](https://github.com/hectorerb/web-mdm-dashboard/commit/a2a7a4b))
* **profiles:** load defaultProfile information ([d343123](https://github.com/hectorerb/web-mdm-dashboard/commit/d343123))
* **profiles:** load location information ([53bef6d](https://github.com/hectorerb/web-mdm-dashboard/commit/53bef6d))
* **profiles:** load title information ([590da98](https://github.com/hectorerb/web-mdm-dashboard/commit/590da98))
* **profiles:** request passwords configuration of glpi ([56e61b7](https://github.com/hectorerb/web-mdm-dashboard/commit/56e61b7))
* **profiles:** show basic user information ([c233df2](https://github.com/hectorerb/web-mdm-dashboard/commit/c233df2))
* **profiles:** update basic user information ([0a459a1](https://github.com/hectorerb/web-mdm-dashboard/commit/0a459a1))
* **profiles:** update emails ([bdd9c1a](https://github.com/hectorerb/web-mdm-dashboard/commit/bdd9c1a))
* **profiles:** validate password ([b6f81d0](https://github.com/hectorerb/web-mdm-dashboard/commit/b6f81d0))
* **Profiles:** add selectors of title, location and default profile ([1b94bf6](https://github.com/hectorerb/web-mdm-dashboard/commit/1b94bf6))
* **Profiles:** create a component for the different inputs ([18ef74b](https://github.com/hectorerb/web-mdm-dashboard/commit/18ef74b))
* **Profiles:** create a component for the different selects ([5a5e0ff](https://github.com/hectorerb/web-mdm-dashboard/commit/5a5e0ff))
* **Profiles:** create a component to iterate data of inputs and selects ([90cea19](https://github.com/hectorerb/web-mdm-dashboard/commit/90cea19))
* **Profiles:** create a function to add emails ([c54fc06](https://github.com/hectorerb/web-mdm-dashboard/commit/c54fc06))
* **Profiles:** create a function to delete an email ([ead2af1](https://github.com/hectorerb/web-mdm-dashboard/commit/ead2af1))
* **Profiles:** create a function to edit the emails ([fb6f1ec](https://github.com/hectorerb/web-mdm-dashboard/commit/fb6f1ec))
* **Profiles:** create the section of emails ([a5b1d56](https://github.com/hectorerb/web-mdm-dashboard/commit/a5b1d56))
* **react-architecture:** add actions pattern to sign in/up ([10473bb](https://github.com/hectorerb/web-mdm-dashboard/commit/10473bb))
* **react-architecture:** add fade animation to auth components ([a7275cf](https://github.com/hectorerb/web-mdm-dashboard/commit/a7275cf))
* **react-architecture:** add hoc for manage notification toast with redux ([8b8ce5b](https://github.com/hectorerb/web-mdm-dashboard/commit/8b8ce5b))
* **react-architecture:** add list & routes to settings & about ([df14c68](https://github.com/hectorerb/web-mdm-dashboard/commit/df14c68))
* **react-architecture:** add logout icon to splitview ([14a4aff](https://github.com/hectorerb/web-mdm-dashboard/commit/14a4aff))
* **react-architecture:** add ui redux context and async component ([09b5215](https://github.com/hectorerb/web-mdm-dashboard/commit/09b5215))
* **react-architecture:** create admin dashboard home route ([f7341c9](https://github.com/hectorerb/web-mdm-dashboard/commit/f7341c9))
* **react-architecture:** create hoc for the dashboard layout ([518b0ae](https://github.com/hectorerb/web-mdm-dashboard/commit/518b0ae))
* **react-architecture:** create splitview component without winjs ([9725d83](https://github.com/hectorerb/web-mdm-dashboard/commit/9725d83))
* **react-architecture:** separate reducers in different folders ([8a6fdbc](https://github.com/hectorerb/web-mdm-dashboard/commit/8a6fdbc))
* **reat-architecture:** add splitview components without winjs ([434b906](https://github.com/hectorerb/web-mdm-dashboard/commit/434b906))
* **register:** add email address to register ([eb4d7e5](https://github.com/hectorerb/web-mdm-dashboard/commit/eb4d7e5))
* **register:** add link go to login ([9b14e63](https://github.com/hectorerb/web-mdm-dashboard/commit/9b14e63))
* **register:** add validation to captcha field ([26d8046](https://github.com/hectorerb/web-mdm-dashboard/commit/26d8046))
* **register:** create new user using glpi library ([2e4ae77](https://github.com/hectorerb/web-mdm-dashboard/commit/2e4ae77))
* **register:** create request to register ([ea226a0](https://github.com/hectorerb/web-mdm-dashboard/commit/ea226a0))
* **register:** create validate account page ([7fb5d42](https://github.com/hectorerb/web-mdm-dashboard/commit/7fb5d42))
* **register:** go to validate account after register ([f684c8b](https://github.com/hectorerb/web-mdm-dashboard/commit/f684c8b))
* **register:** kill session after register user ([6eb1e4f](https://github.com/hectorerb/web-mdm-dashboard/commit/6eb1e4f))
* **register:** request create new user ([80c1fc7](https://github.com/hectorerb/web-mdm-dashboard/commit/80c1fc7))
* **register:** send parameters like object ([ca4ed7c](https://github.com/hectorerb/web-mdm-dashboard/commit/ca4ed7c))
* **register:** validate email valid ([4c1888e](https://github.com/hectorerb/web-mdm-dashboard/commit/4c1888e))
* **resetPassword:** create component to reset password ([e3871ce](https://github.com/hectorerb/web-mdm-dashboard/commit/e3871ce))
* **resetPassword:** handle actions to reset password ([001b3dd](https://github.com/hectorerb/web-mdm-dashboard/commit/001b3dd))
* **resetPassword:** request to reset password ([c6e51b8](https://github.com/hectorerb/web-mdm-dashboard/commit/c6e51b8))
* **routers:** create routers for each page ([510f0a5](https://github.com/hectorerb/web-mdm-dashboard/commit/510f0a5))
* **routes:** add route to reset password ([d24ebf3](https://github.com/hectorerb/web-mdm-dashboard/commit/d24ebf3))
* **search:** add route to search engine ([3b9a680](https://github.com/hectorerb/web-mdm-dashboard/commit/3b9a680))
* **search:** create actions for search query builder component ([fd4817f](https://github.com/hectorerb/web-mdm-dashboard/commit/fd4817f))
* **search:** create content pane to show query data ([7a38625](https://github.com/hectorerb/web-mdm-dashboard/commit/7a38625))
* **search:** create search query builder component ([2fc9e1b](https://github.com/hectorerb/web-mdm-dashboard/commit/2fc9e1b))
* **search:** request item type ([d526199](https://github.com/hectorerb/web-mdm-dashboard/commit/d526199))
* **search-engine:** add to i18n ([be8f71e](https://github.com/hectorerb/web-mdm-dashboard/commit/be8f71e))
* **search-engine:** create components ([#278](https://github.com/hectorerb/web-mdm-dashboard/issues/278)) ([bfa2733](https://github.com/hectorerb/web-mdm-dashboard/commit/bfa2733))
* **settings:** add animation to content pages ([1dffcb2](https://github.com/hectorerb/web-mdm-dashboard/commit/1dffcb2))
* **settings:** add confirmation  message to delete the user ([80d01ce](https://github.com/hectorerb/web-mdm-dashboard/commit/80d01ce))
* **settings:** add confirmation message to kill the session ([8cec3c7](https://github.com/hectorerb/web-mdm-dashboard/commit/8cec3c7))
* **settings:** add display page to i18n ([d8ef2c9](https://github.com/hectorerb/web-mdm-dashboard/commit/d8ef2c9))
* **settings:** add Entity page to i18n ([e09306b](https://github.com/hectorerb/web-mdm-dashboard/commit/e09306b))
* **settings:** add notification to delete browser data ([d325582](https://github.com/hectorerb/web-mdm-dashboard/commit/d325582))
* **settings:** add notification to download URL changed ([e778d9a](https://github.com/hectorerb/web-mdm-dashboard/commit/e778d9a))
* **settings:** add notification to Helpdesk configuration saved ([2656ace](https://github.com/hectorerb/web-mdm-dashboard/commit/2656ace))
* **settings:** add notification to new password saved ([d401bbd](https://github.com/hectorerb/web-mdm-dashboard/commit/d401bbd))
* **settings:** add notification to saved profile ([5c42026](https://github.com/hectorerb/web-mdm-dashboard/commit/5c42026))
* **settings:** add notification to token life changed ([41fe8e5](https://github.com/hectorerb/web-mdm-dashboard/commit/41fe8e5))
* **settings:** add Notifications page to i18n ([269ffcb](https://github.com/hectorerb/web-mdm-dashboard/commit/269ffcb))
* **settings:** add Profiles page to i18n ([203b8a8](https://github.com/hectorerb/web-mdm-dashboard/commit/203b8a8))
* **settings:** add routes to i18n ([b19c610](https://github.com/hectorerb/web-mdm-dashboard/commit/b19c610))
* **settings:** add Security page to i18n ([4e9cf58](https://github.com/hectorerb/web-mdm-dashboard/commit/4e9cf58))
* **settings:** add Supervision page to i18n ([e1f5064](https://github.com/hectorerb/web-mdm-dashboard/commit/e1f5064))
* **settings:** add supervision to settings list ([838f136](https://github.com/hectorerb/web-mdm-dashboard/commit/838f136))
* **settings:** close session in the security page ([c613ffa](https://github.com/hectorerb/web-mdm-dashboard/commit/c613ffa))
* **settings:** create a component of the 'Display' screen ([4047f9b](https://github.com/hectorerb/web-mdm-dashboard/commit/4047f9b))
* **settings:** create a component of the 'Notifications' screen ([a2094de](https://github.com/hectorerb/web-mdm-dashboard/commit/a2094de))
* **settings:** create a component of the 'Security' screen ([da16f70](https://github.com/hectorerb/web-mdm-dashboard/commit/da16f70))
* **settings:** create entity screen ([4785368](https://github.com/hectorerb/web-mdm-dashboard/commit/4785368))
* **settings:** create screen for 'change download URL' ([76d3600](https://github.com/hectorerb/web-mdm-dashboard/commit/76d3600))
* **settings:** create screen for 'change Token life' ([a4f51b1](https://github.com/hectorerb/web-mdm-dashboard/commit/a4f51b1))
* **settings:** create section to change the password ([a76d551](https://github.com/hectorerb/web-mdm-dashboard/commit/a76d551))
* **settings:** delete browser data in the security page ([7c720d9](https://github.com/hectorerb/web-mdm-dashboard/commit/7c720d9))
* **settings:** delete current user on the security page ([9a9f3d5](https://github.com/hectorerb/web-mdm-dashboard/commit/9a9f3d5))
* **settings:** get applications uploaded from glpi ([8fe6ecd](https://github.com/hectorerb/web-mdm-dashboard/commit/8fe6ecd))
* **settings:** get devices currently managed from glpi ([1821c68](https://github.com/hectorerb/web-mdm-dashboard/commit/1821c68))
* **settings:** get files uploaded from glpi ([458703a](https://github.com/hectorerb/web-mdm-dashboard/commit/458703a))
* **settings:** get fleets currently managed from glpi ([54a1be9](https://github.com/hectorerb/web-mdm-dashboard/commit/54a1be9))
* **settings:** get invitations sent from glpi ([1f36d46](https://github.com/hectorerb/web-mdm-dashboard/commit/1f36d46))
* **settings:** get number categories for policies from glpi ([3c89f64](https://github.com/hectorerb/web-mdm-dashboard/commit/3c89f64))
* **settings:** get number users from glpi ([389cbb8](https://github.com/hectorerb/web-mdm-dashboard/commit/389cbb8))
* **settings:** get supervision data from glpi ([bd45150](https://github.com/hectorerb/web-mdm-dashboard/commit/bd45150))
* **settings:** get types policies from glpi ([923fceb](https://github.com/hectorerb/web-mdm-dashboard/commit/923fceb))
* **settings:** load data on the profiles screen ([ea79f07](https://github.com/hectorerb/web-mdm-dashboard/commit/ea79f07))
* **settings:** remove maximun managed devices ([22481d3](https://github.com/hectorerb/web-mdm-dashboard/commit/22481d3))
* **settings:** save changes of supervision data in glpi ([8d929a3](https://github.com/hectorerb/web-mdm-dashboard/commit/8d929a3))
* **settings:** save new password on the security page ([fee3d48](https://github.com/hectorerb/web-mdm-dashboard/commit/fee3d48))
* **settings:** self delete account only available for demo mode ([32faf19](https://github.com/hectorerb/web-mdm-dashboard/commit/32faf19))
* **settings:** show indications when do not found data ([8219098](https://github.com/hectorerb/web-mdm-dashboard/commit/8219098))
* **settings:** show supervision data of glpi ([64384e2](https://github.com/hectorerb/web-mdm-dashboard/commit/64384e2))
* **settings:** validate the new password according to the configuration ([0e5b79d](https://github.com/hectorerb/web-mdm-dashboard/commit/0e5b79d))
* **sign-in:** add support to credential management API ([59ea76c](https://github.com/hectorerb/web-mdm-dashboard/commit/59ea76c))
* **sign-in:** add to i18n ([e23744a](https://github.com/hectorerb/web-mdm-dashboard/commit/e23744a))
* **sign-up:** add to i18n ([335f9b3](https://github.com/hectorerb/web-mdm-dashboard/commit/335f9b3))
* **SignIn:** add toast notifications ([ecf0f11](https://github.com/hectorerb/web-mdm-dashboard/commit/ecf0f11))
* **SignIn:** create form of create user ([5608018](https://github.com/hectorerb/web-mdm-dashboard/commit/5608018))
* **SignIn:** load the cargo component when necessary ([dc98413](https://github.com/hectorerb/web-mdm-dashboard/commit/dc98413))
* **SignIn:** pass parameter to force validation ([0589d8c](https://github.com/hectorerb/web-mdm-dashboard/commit/0589d8c))
* **SignIn:** redirect when all data is valid ([e6ef7f5](https://github.com/hectorerb/web-mdm-dashboard/commit/e6ef7f5))
* **SignIn:** request the password settings when loading the screen ([ec2cca3](https://github.com/hectorerb/web-mdm-dashboard/commit/ec2cca3))
* **SignIn:** request validation of input data ([70c9458](https://github.com/hectorerb/web-mdm-dashboard/commit/70c9458))
* **SignIn:** validate password according to specifications ([9f1f829](https://github.com/hectorerb/web-mdm-dashboard/commit/9f1f829))
* **SignUp:** add toast notifications ([4aff510](https://github.com/hectorerb/web-mdm-dashboard/commit/4aff510))
* **SingUp:** link 'Forgot my password' to '/forgotPassword' ([e9c8589](https://github.com/hectorerb/web-mdm-dashboard/commit/e9c8589))
* **style:** add files icon ([b68264c](https://github.com/hectorerb/web-mdm-dashboard/commit/b68264c))
* **style:** change font according to font-weight ([5076270](https://github.com/hectorerb/web-mdm-dashboard/commit/5076270))
* **styles:** add 'addIcon' ([72c11d8](https://github.com/hectorerb/web-mdm-dashboard/commit/72c11d8))
* **styles:** add 'cancelIcon' ([0a988aa](https://github.com/hectorerb/web-mdm-dashboard/commit/0a988aa))
* **styles:** add 'clearIcon' ([341aad4](https://github.com/hectorerb/web-mdm-dashboard/commit/341aad4))
* **styles:** add 'detailsIcon' ([75b5c58](https://github.com/hectorerb/web-mdm-dashboard/commit/75b5c58))
* **styles:** add 'monthIcon' ([c4721a9](https://github.com/hectorerb/web-mdm-dashboard/commit/c4721a9))
* **styles:** add 'permissionsIcon' ([47607fe](https://github.com/hectorerb/web-mdm-dashboard/commit/47607fe))
* **styles:** add 'searchIcon' ([1c92138](https://github.com/hectorerb/web-mdm-dashboard/commit/1c92138))
* **styles:** add 'viewIcon' ([71432c2](https://github.com/hectorerb/web-mdm-dashboard/commit/71432c2))
* **styles:** add class 'editIcon' ([c14b3b8](https://github.com/hectorerb/web-mdm-dashboard/commit/c14b3b8))
* **styles:** add save icon ([5238f05](https://github.com/hectorerb/web-mdm-dashboard/commit/5238f05))
* **styles:** add styles for chart box ([01cf682](https://github.com/hectorerb/web-mdm-dashboard/commit/01cf682))
* **styles:** add styles for maps ([d20adbf](https://github.com/hectorerb/web-mdm-dashboard/commit/d20adbf))
* **styles:** create styles for error messages ([948b1fe](https://github.com/hectorerb/web-mdm-dashboard/commit/948b1fe))
* **styles:** create styles for file upload component ([52afe56](https://github.com/hectorerb/web-mdm-dashboard/commit/52afe56))
* **supervision:** create fake info about supervisor ([1c48d74](https://github.com/hectorerb/web-mdm-dashboard/commit/1c48d74))
* **supervision:** create schema for supervisor form ([5a3ee0e](https://github.com/hectorerb/web-mdm-dashboard/commit/5a3ee0e))
* **supervision:** create supervision form ([53b7216](https://github.com/hectorerb/web-mdm-dashboard/commit/53b7216))
* **systemReport:** create component for show inventory ([567e614](https://github.com/hectorerb/web-mdm-dashboard/commit/567e614))
* **systemReport:** get agent system information ([67e4706](https://github.com/hectorerb/web-mdm-dashboard/commit/67e4706))
* **systemReport:** get device main information ([16f05a7](https://github.com/hectorerb/web-mdm-dashboard/commit/16f05a7))
* **systemReport:** request feet information ([4c268ff](https://github.com/hectorerb/web-mdm-dashboard/commit/4c268ff))
* **systemReport:** send request with parameters ([72b1f01](https://github.com/hectorerb/web-mdm-dashboard/commit/72b1f01))
* **systemReport:** show loading indicator ([86691f7](https://github.com/hectorerb/web-mdm-dashboard/commit/86691f7))
* **SystemReport:** create the list of system reports ([8db9d32](https://github.com/hectorerb/web-mdm-dashboard/commit/8db9d32))
* **tooltip:** show tooltip when select icon menu ([a7a29c1](https://github.com/hectorerb/web-mdm-dashboard/commit/a7a29c1))
* **user:** add information to hyperlinks ([687a014](https://github.com/hectorerb/web-mdm-dashboard/commit/687a014))
* **user:** get current user ([8138696](https://github.com/hectorerb/web-mdm-dashboard/commit/8138696))
* **users:** add 'DatePicker' to the corresponding fields ([58434c1](https://github.com/hectorerb/web-mdm-dashboard/commit/58434c1))
* **users:** add 'Selects' to the corresponding fields ([282611d](https://github.com/hectorerb/web-mdm-dashboard/commit/282611d))
* **users:** add 'TextArea' to the corresponding fields ([5ae1704](https://github.com/hectorerb/web-mdm-dashboard/commit/5ae1704))
* **users:** add DevicesEdit component to i18n ([7294fc1](https://github.com/hectorerb/web-mdm-dashboard/commit/7294fc1))
* **users:** add function to change 'field' ([26c7f4f](https://github.com/hectorerb/web-mdm-dashboard/commit/26c7f4f))
* **users:** add notification to delete users ([de54cc3](https://github.com/hectorerb/web-mdm-dashboard/commit/de54cc3))
* **users:** add notification to edited users ([a59bf5e](https://github.com/hectorerb/web-mdm-dashboard/commit/a59bf5e))
* **users:** add progressive loading to listview ([9cad1a3](https://github.com/hectorerb/web-mdm-dashboard/commit/9cad1a3))
* **users:** add routes to i18n ([561ca35](https://github.com/hectorerb/web-mdm-dashboard/commit/561ca35))
* **users:** add text inputs to the corresponding fields ([8ed6cac](https://github.com/hectorerb/web-mdm-dashboard/commit/8ed6cac))
* **users:** add UsersContent component to i18n ([9bc1be2](https://github.com/hectorerb/web-mdm-dashboard/commit/9bc1be2))
* **users:** add UsersEditOne component to i18n ([e5e7a56](https://github.com/hectorerb/web-mdm-dashboard/commit/e5e7a56))
* **users:** add UsersList component to i18n ([a0dee20](https://github.com/hectorerb/web-mdm-dashboard/commit/a0dee20))
* **users:** allow edit multiple users ([89cdb2b](https://github.com/hectorerb/web-mdm-dashboard/commit/89cdb2b))
* **users:** asynchronously load the password settings ([0e8ed69](https://github.com/hectorerb/web-mdm-dashboard/commit/0e8ed69))
* **users:** confirm delete item ([7cde74a](https://github.com/hectorerb/web-mdm-dashboard/commit/7cde74a))
* **users:** create a screen for edit configuration ([99a35b4](https://github.com/hectorerb/web-mdm-dashboard/commit/99a35b4))
* **users:** create a structure for the component ([1e620f7](https://github.com/hectorerb/web-mdm-dashboard/commit/1e620f7))
* **users:** create router for users ([ade3d52](https://github.com/hectorerb/web-mdm-dashboard/commit/ade3d52))
* **users:** delete a single item ([0781546](https://github.com/hectorerb/web-mdm-dashboard/commit/0781546))
* **users:** get user to edit information ([309e17f](https://github.com/hectorerb/web-mdm-dashboard/commit/309e17f))
* **users:** request validate account ([0daf99c](https://github.com/hectorerb/web-mdm-dashboard/commit/0daf99c))
* **users:** save the new value in glpi ([3870520](https://github.com/hectorerb/web-mdm-dashboard/commit/3870520))
* **users:** show user profile image ([cded9ab](https://github.com/hectorerb/web-mdm-dashboard/commit/cded9ab))
* **users:** use the custom select and add a list of options ([0953476](https://github.com/hectorerb/web-mdm-dashboard/commit/0953476))
* **users:** validate new passwords ([19d3f3e](https://github.com/hectorerb/web-mdm-dashboard/commit/19d3f3e))
* **util:** create ErrorValidation component ([99bdbee](https://github.com/hectorerb/web-mdm-dashboard/commit/99bdbee))
* **utils:** create 'EmptyList' component ([cfa5323](https://github.com/hectorerb/web-mdm-dashboard/commit/cfa5323))
* **utils:** create 'Loading' component ([53ccc7c](https://github.com/hectorerb/web-mdm-dashboard/commit/53ccc7c))
* **utils:** create a confirmation message component ([8ec108d](https://github.com/hectorerb/web-mdm-dashboard/commit/8ec108d))
* **utils:** create a function to validate the data displayed ([8ab21cb](https://github.com/hectorerb/web-mdm-dashboard/commit/8ab21cb))
